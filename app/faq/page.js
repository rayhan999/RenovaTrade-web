...
export default function FaqPage() {
  const { t } = useLanguage()
  const faqs = [
    { q: "Which Incoterms do you trade on?", a: "Most of our contracts are FOB (European port of loading), CFR, or CIF Chattogram. FOB suits buyers with their own freight arrangements; CFR/CIF means we book the ocean freight — and under CIF we also arrange marine cargo insurance. EXW, FCA, or CPT can be agreed for specific cargo. All references are to Incoterms 2020." },
    { q: "How long from quote to delivery?", a: "A complete requirement normally gets a quotation within 3–5 business days. After order confirmation, scrap cargo typically ships within 2–4 weeks and inspected heavy equipment within 3–6 weeks. Ocean transit from Northern Europe to Chattogram adds roughly 4–6 weeks depending on routing. These are indicative ranges; the contract states committed dates." },
