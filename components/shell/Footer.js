...
export default function Footer() {
  ...
  const usefulLinks = [
    ...
    { name: t('nav.products'), href: "/services-and-solutions" },
    { name: t('nav.industries'), href: "/industries" },
    { name: t('nav.workApproach'), href: "/how-we-work" },
      ...
      <div className="container-renova py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Social icons — temporarily hidden per request. The original row
                (Twitter / Facebook / LinkedIn / Instagram) is preserved below
                as a comment so it can be restored without re-importing the
                SVG paths.
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold mb-5">{t('nav.servicesSolutions')}</h3>
            <ul className="space-y-3">
              {services.map((link) => (
                <li key={link.name}>
                  <Link
